...
Description:
    ...
    Added features with thread safety, movement thresholds, config files,
    More robust calibration, and smoothing profiles (and multiple profiles) for reduced jitter.
"""
...
from head_tracking_helper import EnhancedCalibrator, SmoothingProfiles, SmoothingProfile
