...
class Widget_AR(QWidget):
    ...
    def __init__(self):
        ...
        self.Display_Label = QLabel("النص")
        ...
        self.Keyboard_Layout_ROW1.addWidget(self.Letter_Button11)
        self.Keyboard_Layout_ROW1.addWidget(self.Letter_Button12)
        ...
        self.Keyboard_Layout_ROW2.addWidget(self.Letter_Button20)
        self.Keyboard_Layout_ROW2.addWidget(self.Letter_Button21)
        ...
        self.Keyboard_Layout_ROW3.addWidget(self.Letter_Button30)
        self.Keyboard_Layout_ROW3.addWidget(self.Letter_Button31)
        self.Keyboard_Layout_ROW3.addWidget(self.Letter_Button32)
